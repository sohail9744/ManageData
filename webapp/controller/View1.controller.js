sap.ui.define([
    ...
    function (Controller, Filter, FilterOperator, Fragment) {
        ...
        return Controller.extend("Iffco.createCustomer.controller.View1", {
            onInit: function () {
                ...
                for(var i=0; i < oFilter.getAllFilterItems().length; i++){
                    ...
                    var sKeys = [];
                     if(sName === "Request Number"){
                        ...
                        aFilters.push(new Filter({ path: sPath, operator: FilterOperator.LE, value1: to }));
                        }
                    }
            ...
            handleEditCustomer: function (oEvent) {
                ...
                if (!this._pDialog) {
                    this._pDialog = Fragment.load({
                        id: oView.getId(),
                        name: "Iffco.createCustomer.fragments.LegalName",
                        controller: this
