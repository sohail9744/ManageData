  ...
  function (Controller, Filter, FilterOperator, Fragment, formatter) {
    ...
    return Controller.extend("Iffco.clap.controller.View1", {
      ...
      onInit: function () {
        ...
        this.check2 = false;
        if (!this.bulkRequest) {
          this.bulkRequest = new sap.ui.xmlfragment(
            "Iffco.clap.fragments.bulkUpload",
            this
          );
        ...
        if (!this.ex) {
          this.ex = new sap.ui.xmlfragment(
            "Iffco.clap.fragments.ExistingCustomer",
            this
          );
      ...
      handleRequestnavigation: function (oEvent) {
        ...
        let cashOrCredit = oEvent
          .getSource()
          .getBindingContext()
          .getProperty("zdescription");
        let zStatus = oEvent
          .getSource()
          .getBindingContext()
          .getProperty("zrequest_status");
        if (process === "Extend Customer") {
          process = "EXTEND";
        }

        //below we are setting according to the status which fields should be visible clapfields or MDG(status)
        ...
        oRouter.navTo("CustomerDetail", {
          zcustomer_num: oEvent
            .getSource()
            .getBindingContext()
            .getProperty("zcustomer_num"),
          zsales_orgnization: oEvent
            .getSource()
            .getBindingContext()
            .getProperty("zsales_orgnization"),
      ...
      getSelections: function (evt) {
        ...
        this.zcustomer_legal_name = evt
          .getSource()
          .getSelectedContexts()[0]
          .getObject().zcustomer_legal_name;
        this.zbusinessPartnerId = evt
          .getSource()
          .getSelectedContexts()[0]
          .getObject().zbusiness_partner_id;
      },
