sap.ui.define(
  ...
  function (Controller, MessageBox, MessageToast) {
    ...
    return Controller.extend(
      "Iffco.clap.sections.SalesArea.AccountingController",
      {
        onInit: function () {
          //debugger
          if (!this.salesData) {
            this.salesData = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.SalesFields",
              this
            );
            this.getView().addDependent(this.salesData);
          }
          if (!this.bp) {
            this.bp = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.BpRelation",
              this
            );
            this.getView().addDependent(this.bp);
          }
          if (!this.salesOrganization) {
            this.salesOrganization = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.SalesOrg",
              this
            );
            this.getView().addDependent(this.salesOrganization);
            this.salesOrganization.setModel(
              this.getOwnerComponent().getModel()
            );
          }
          if (!this.distribution) {
            this.distribution = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.Distribution",
              this
            );
            this.getView().addDependent(this.distribution);
            this.distribution.setModel(
              this.getOwnerComponent().getModel("DistChannelModel")
            );
          }
          if (!this.division) {
            this.division = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.DivisionSet",
              this
            );
            this.getView().addDependent(this.division);
            this.division.setModel(
              this.getOwnerComponent().getModel("DivModel")
            );
          }

          if (!this.InvcDates) {
            this.InvcDates = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.InvcDates",
              this
            );
          ...
          if (!this.InvcLists) {
            this.InvcLists = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.InvcList",
              this
            );
          ...
          if (!this.customerGrp) {
            this.customerGrp = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.CustGroup",
              this
            );
          ...
          if (!this.TaxCategory) {
            this.TaxCategory = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.TaxCategory",
              this
            );
          ...
          if (!this.TaxClassfn) {
            this.TaxClassfn = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.TaxClassfn",
              this
            );
          ...
          if (!this.customerGrp1) {
            this.customerGrp1 = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.custGrp1",
              this
            );
            this.getView().addDependent(this.customerGrp1);
            this.customerGrp1.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.customerGrp2) {
            this.customerGrp2 = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.custGrp2",
              this
            );
            this.getView().addDependent(this.customerGrp2);
            this.customerGrp2.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.customerGrp3) {
            this.customerGrp3 = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.custGrp3",
              this
            );
            this.getView().addDependent(this.customerGrp3);
            this.customerGrp3.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.customerGrp4) {
            this.customerGrp4 = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.custGrp4",
              this
            );
            this.getView().addDependent(this.customerGrp4);
            this.customerGrp4.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.customerGrp5) {
            this.customerGrp5 = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.custGrp5",
              this
            );
            this.getView().addDependent(this.customerGrp5);
            this.customerGrp5.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.DelvryPlant) {
            this.DelvryPlant = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.DeliveryPlant",
              this
            );
          ...
          // }
          if (!this.CCA) {
            this.CCA = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.CreditControl",
              this
            );
          ...
          if (!this.Incoterms) {
            this.Incoterms = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.Incoterms",
              this
            );
          ...
          if (!this.PriceGroup) {
            this.PriceGroup = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.priceGroup",
              this
            );
          ...
          if (!this.PPDetermination) {
            this.PPDetermination = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.PpDetermination",
              this
            );
          ...
          if (!this.PriceList) {
            this.PriceList = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.priceList",
              this
            );
          ...
          if (!this.Authorization) {
            this.Authorization = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.AuthorizationGrp",
              this
            );
          ...
          if (!this.salesDist) {
            this.salesDist = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.salesDistrict",
              this
            );
          ...
          if (!this.DelvryPriorty) {
            this.DelvryPriorty = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.delvryPriorty",
              this
            );
            this.getView().addDependent(this.DelvryPriorty);
            this.DelvryPriorty.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.ShippingCondn) {
            this.ShippingCondn = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.ShippingCondn",
              this
            );
            this.getView().addDependent(this.ShippingCondn);
            this.ShippingCondn.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          ...
          if (!this.blockReason) {
            this.blockReason = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.BlockedReason",
              this
            );
          ...
          if (!this.cs) {
            this.cs = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.creditSegmentData",
              this
            );
          ...
          // Block Sales Area Framgment

          if (!this.salesBlockAll) {
            this.salesBlockAll = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.SalesOrderBlockAll",
              this
            );
            this.getView().addDependent(this.salesBlockAll);
            this.salesBlockAll.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.salesBlockSel) {
            this.salesBlockSel = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.SalesOrderBlockSelected",
              this
            );
            this.getView().addDependent(this.salesBlockSel);
            this.salesBlockSel.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.deliveryBlockAll) {
            this.deliveryBlockAll = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.deliveryBlockAll",
              this
            );
            this.getView().addDependent(this.deliveryBlockAll);
            this.deliveryBlockAll.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.deliveryBlockSel) {
            this.deliveryBlockSel = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.deliveryBlockSel",
              this
            );
            this.getView().addDependent(this.deliveryBlockSel);
            this.deliveryBlockSel.setModel(this.getOwnerComponent().getModel());
          }
          if (!this.billingBlockAll) {
            this.billingBlockAll = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.BillingBlockAll",
              this
            );
            this.getView().addDependent(this.billingBlockAll);
            this.billingBlockAll.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          if (!this.billingBlockSel) {
            this.billingBlockSel = new sap.ui.xmlfragment(
              "Iffco.clap.fragments.BillingBlockSel",
              this
            );
            this.getView().addDependent(this.billingBlockSel);
            this.billingBlockSel.setModel(
              this.getOwnerComponent().getModel("S4D")
            );
          }
          // Block Sales Area END
        },
        ...
        handleAddSalesGrid: function (evt) {
          ...
          if (salesState == true) {
            var salesOrg = this.salesData
              .getContent()[0]
              .getContent()[1]
              .getValue();
            var distribution = this.salesData
              .getContent()[0]
              .getContent()[3]
              .getValue();
            var division = this.salesData
              .getContent()[0]
              .getContent()[5]
              .getValue();
        ...
        handleDeleteSalesGrid: function (e) {
          ...
          if (
            e.getSource().getBindingContext("salesModel").getObject()
              .zsales_area_id !== undefined
          ) {
            var salesAreaId = e
              .getSource()
              .getBindingContext("salesModel")
              .getObject().zsales_area_id;
            var custNum = e
              .getSource()
              .getBindingContext("salesModel")
            ...
            var salesOrg = e
              .getSource()
              .getBindingContext("salesModel")
              .getObject().zsales_orgnization;
            that.dPath =
              "/ZDD_CUST_SALESAREAS(zcustomer_num=guid'" +
              custNum +
              "',zsales_orgnization='" +
              salesOrg +
              "',zsales_area_id='" +
            ...
            e.getSource().getBindingContext("salesModel").getObject().Flag =
              "D";
            e.getSource()
              .getBindingContext("salesModel")
              .getModel()
        ...
        handleValueHelpDistributionConfirm: function (evt) {
          this.distributionTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          var desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.distributionField.setValue(
            this.distributionTitle + " - " + desc
          );
          this.getView()
            .getModel("appView")
            .setProperty("/distributionChannel", this.distributionTitle);
        },
        ...
        handleCreate: function (evt) {
          ...
          //   let isValid = this.handleValidateSalesFields();
          //   if (firstComing === 0) {
          //     isValid = true;
          //     firstComing++
          //   }
          ...
          var count = this.getView()
            .getModel("salesDataModel")
            .getData().length;
          var container = this.getView().byId("container");
          this.salesPanel = new sap.ui.xmlfragment(
            "frag" + count,
            "Iffco.clap.fragments.salesPanel",
            this
          );
          ...
          this.getOwnerComponent()
            .getModel("salesDataModel")
            .getData()
            .push(JSON.parse(JSON.stringify(objects)));
          this.getOwnerComponent()
            .getModel("salesDataModel")
            .updateBindings(true);
          ...
          var simpleForm = this.salesPanel
            .getItems()[0]
            .getContent()[0]
            .getItems()[0];
          ...
          if (custdata.zbusiness_unit_name) {
            oModel.read("/ZDD_BU_CC_VH", {
              success: function (oData, oResponse) {
                ...
                var bpValue = this.getOwnerComponent()
                  .getModel("salesDataModel")
                  .getData();
          ...
          //   } else {
          //     MessageToast.show("Please first Enter the Sales Area Data");
          //   }
        },
        handleGenerateSales: function () {
          ...
          if (
            this.getView().getModel("appView").getProperty("/generateSale") ===
            false
          ) {
            if (
              this.getView().getModel("salesDataModel").getData().length > 0
            ) {
              for (
                var i = 0;
                i < this.getView().getModel("salesDataModel").getData().length;
                i++
              ) {
                var count = i;
                var container = this.getView().byId("container");

                var salesPanel = new sap.ui.xmlfragment(
                  "frag" + count,
                  "Iffco.clap.fragments.salesPanel",
                  this
                );
                ...
                var salesOrg = this.getView()
                  .getModel("salesDataModel")
                  .getData()[i].zsales_orgnization;
                var distribution = this.getView()
                  .getModel("salesDataModel")
                  .getData()[i].zdistribution_channel;
                var division = this.getView()
                  .getModel("salesDataModel")
                  .getData()[i].zdivision;

                var headerText = salesPanel
                  .getItems()
                  [i].getHeaderToolbar()
                  .getContent()[0]
                  .getText();
        ...
        handleValueHelpForCreditControl: function (evt) {
          ...
          let disTributionCh = evt
            .getSource()
            .getBindingContext("salesDataModel")
            .getObject("zdistribution_channel");
          if (disTributionCh) {
            this.CCA.getBinding("items").filter([
              new sap.ui.model.Filter(
                "DistributionChannel",
                "EQ",
                disTributionCh
        ...
        handleValueHelpCCASearch: function (evt) {
          var sValue = evt.getParameter("value");
          var val1 = this.getView()
            .getModel("appView")
            .getProperty("/distributionChannel");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            if (val1.length > 0) {
              filters.push(
                new sap.ui.model.Filter("distribution_channel", "EQ", val1)
              );
            }
        ...
        handleValueHelpForTaxClssfn: function (evt) {
          ...
          if (this.taxCatTitle) {
            this.TaxClassfn.getBinding("items").filter([
              new sap.ui.model.Filter("Taxcategory", "EQ", this.taxCatTitle),
            ]);
            ...
            this.cs
              ...
              .filter([
                new sap.ui.model.Filter(
                  "credit_control_area",
                  "EQ",
                  this.getView().getModel("appView").getProperty("/cca")
                ),
                new sap.ui.model.Filter("SalesOrg", "EQ", this.salesTitle),
              ]);
            this.cs.open();
        ...
        onChangeBP: function (evt) {
          ...
          const bpId = this.getView()
            .getModel("Customers")
            .getData().zbusiness_unit_name;
          if (bpId) {
            this.bp
              .getBinding("items")
              .filter([new sap.ui.model.Filter("Businessunit", "EQ", bpId)]);
            this.bp.open();
          } else {
        ...
        handleValueHelpBpSearch: function (evt) {
          ...
          if (sValue.length > 0) {
            ...
            this.bp
              .getBinding("items")
              .filter([new sap.ui.model.Filter("Businessunit", "EQ", mBPID)]);
          }
        },
        ...
        // Block sales area functionality
        // All Block Sales
        handleValueHelpForBlockAllSales: function (evt) {
          this.salesBlockAllField = evt.getSource();
          this.salesBlockAll.getBinding("items").filter([]);
          this.salesBlockAll.open();
        },
        handleAllBlockSalesConfirm: function (evt) {
          this.blockSalesAllTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          var desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.salesBlockAllField.setValue(
            this.blockSalesAllTitle + " - " + desc
          );
        },
        handleAllBlockSalesSearch: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
              path: "Salesorderblock",
              operator: "Contains",
              value1: sValue,
            });
            var filter2 = new sap.ui.model.Filter({
              path: "SalesorderblockDesc",
              operator: "Contains",
              value1: sValue,
            });
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.salesBlockAll.getBinding("items").filter(filters, false);
          } else {
            this.salesBlockAll.getBinding("items").filter([]);
          }
        },

        // Selected Sales block
        handleValueHelpForBlockSelectedSales: function (evt) {
          this.salesBlockSelField = evt.getSource();
          this.salesBlockSel.getBinding("items").filter([]);
          this.salesBlockSel.open();
        },
        handleSelBlockSalesConfirm: function (evt) {
          this.blockSalesSelTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          let desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.salesBlockSelField.setValue(
            this.blockSalesSelTitle + " - " + desc
          );
        },
        handleSelBlockSalesSearch: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.salesBlockSel.getBinding("items").filter(filters, false);
          } else {
            this.salesBlockSel.getBinding("items").filter([]);
          }
        },
        ...
        //Delivery Block All
        handleValueHelpForDelBlockAll: function (evt) {
          this.deliveryBlockAllField = evt.getSource();
          this.deliveryBlockAll.getBinding("items").filter([]);
          this.deliveryBlockAll.open();
        },
        handleDelBlockAllConfirm: function (evt) {
          this.deliveryBlockAllTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          let desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.deliveryBlockAllField.setValue(
            this.deliveryBlockAllTitle + " - " + desc
          );
        },
        handleValueHelpSalesDelBlockAll: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            var filter2 = new sap.ui.model.Filter({
              path: "DeliveryblockDesc",
              operator: "Contains",
              value1: sValue,
            });
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.deliveryBlockAll.getBinding("items").filter(filters, false);
          } else {
            this.deliveryBlockAll.getBinding("items").filter([]);
          }
        },
        ...
        handleValueHelpForDelBlockSel: function (evt) {
          this.deliveryBlockSelField = evt.getSource();
          this.deliveryBlockSel.getBinding("items").filter([]);
          this.deliveryBlockSel.open();
        },
        handleDelBlockSelConfirm: function (evt) {
          this.deliveryBlockSelTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          let desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.deliveryBlockSelField.setValue(
            this.deliveryBlockSelTitle + " - " + desc
          );
        },
        handleValueHelpSalesDelBlockSel: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.deliveryBlockSel.getBinding("items").filter(filters, false);
          } else {
            this.deliveryBlockSel.getBinding("items").filter([]);
          }
        },
        ...
        //Billing Block all
        handleValueHelpForBillingBlockAll: function (evt) {
          this.billingBlockAllField = evt.getSource();
          this.billingBlockAll.getBinding("items").filter([]);
          this.billingBlockAll.open();
        },
        BillingBlockAllConfirm: function (evt) {
          this.billingBlockAllTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          let desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.billingBlockAllField.setValue(
            this.billingBlockAllTitle + " - " + desc
          );
        },
        ValueHelpBillingBlockAllSearch: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.billingBlockAll.getBinding("items").filter(filters, false);
          } else {
            this.billingBlockAll.getBinding("items").filter([]);
          }
        },
        ...
        //Billing Block sel
        handleValueHelpForBillingBlockSel: function (evt) {
          this.billingBlockSelField = evt.getSource();
          this.billingBlockSel.getBinding("items").filter([]);
          this.billingBlockSel.open();
        },
        handleBillingBlockSelConfirm: function (evt) {
          this.billingBlockSelTitle = evt
            .getParameter("selectedItems")[0]
            .getProperty("title");
          let desc = evt
            .getParameter("selectedItems")[0]
            .getProperty("description");
          this.billingBlockSelField.setValue(
            this.billingBlockSelTitle + " - " + desc
          );
        },
        handleValueHelpBillingBlockSelSearch: function (evt) {
          var sValue = evt.getParameter("value");
          var filters = [];
          if (sValue.length > 0) {
            var filter1 = new sap.ui.model.Filter({
            ...
            var sFilters = [filter1, filter2];
            filters.push(new sap.ui.model.Filter(sFilters, false));
            this.billingBlockSel.getBinding("items").filter(filters, false);
          } else {
            this.billingBlockSel.getBinding("items").filter([]);
          }
        },
